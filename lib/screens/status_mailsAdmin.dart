...
import '../widgets/myGroupListAdmin.dart';

class StatusMailsAdmin extends ConsumerWidget {
  final _controller = ScrollController();
  final Status status;

  StatusMailsAdmin({Key? key, required this.status}) : super(key: key);
        ...
        Consumer(
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return futureCategories.when(
              data: (categories) => MyGroupListAdmin(
                mails: mails!,
