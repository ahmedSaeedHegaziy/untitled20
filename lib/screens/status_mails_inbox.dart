...
class StatusMailsInbox extends ConsumerWidget {
  final _controller = ScrollController();

  StatusMailsInbox({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isHover = ref.watch(hoverStateFuture);
    final statusFuture = ref.watch(statusStateFuture(1));
    return Scaffold(
        ...
        Consumer(
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return futureCategories.when(
              data: (categories) => MyGroupListInbox(
                mails: mails!,
