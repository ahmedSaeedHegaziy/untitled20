...
import '../widgets/myGroupList_Inprogress.dart';

class StatusMailsInprogress extends ConsumerWidget {
  final _controller = ScrollController();

  StatusMailsInprogress({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isHover = ref.watch(hoverStateFuture);
    final statusFuture = ref.watch(statusStateFuture(3));
    return Scaffold(
        ...
        Consumer(
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return futureCategories.when(
              data: (categories) => MyGroupListInprogress(
                mails: mails!,
