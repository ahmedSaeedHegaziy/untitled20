...
import 'package:untitled20/screens/crateaccount.dart';
import 'package:untitled20/screens/search_screen.dart';
import 'package:untitled20/screens/search_with_tag.dart';
import 'package:untitled20/screens/sender_mails.dart';
import 'package:untitled20/screens/sender_search.dart';
import 'package:untitled20/screens/status_mails.dart';
import 'package:untitled20/screens/status_mails_Completed.dart';
import 'package:untitled20/screens/status_mails_Inprogress.dart';
import 'package:untitled20/screens/status_mails_inbox.dart';
      ...
      children: [
        ...
        Consumer(
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return userRoleFuture.when(data: (userRole) {
              if (userRole == 'admin') {
                return futureStatuses.when(
                  data: (statuses) => MyGridViwAdmin(statuses: statuses),
                  loading: () {
                    return const SizedBox(
                      height: 10,
                      child: Center(
...
Future<List<dynamic>> fetchMails() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      mails = jsonDecode(response.body)['mails'];
